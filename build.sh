...
export XMRIG_BUILD_ARGS="-DXMRIG_DEPS=scripts/deps -DBUILD_STATIC=ON -DWITH_HWLOC=OFF -DWITH_OPENCL=OFF -DCMAKE_SYSTEM_NAME=Linux"
...
if [[ "$ARCH" == *"aarch64"* ]]; then 
  ...
  XMRIG_BUILD_ARGS="$XMRIG_BUILD_ARGS -DCMAKE_SYSTEM_PROCESSOR=arm"
